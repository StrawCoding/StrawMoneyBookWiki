...
- 使用：[`frontend/scripts/prepare-android-release.mjs`](https://github.com/StrawCoding/StrawMoneyBook/blob/main/frontend/scripts/prepare-android-release.mjs)
...
- 上傳到 GitHub Release：[`frontend/scripts/upload-aab-to-github.mjs`](https://github.com/StrawCoding/StrawMoneyBook/blob/main/frontend/scripts/upload-aab-to-github.mjs)
...
## 引用來源
- [`./.github/workflows/play-release.yml`](https://github.com/StrawCoding/StrawMoneyBook/blob/main/.github/workflows/play-release.yml)
- [`./.github/workflows/play-production-release.yml`](https://github.com/StrawCoding/StrawMoneyBook/blob/main/.github/workflows/play-production-release.yml)
